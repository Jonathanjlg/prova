       ...
       let numerosPorExtenso = [
        ...
        function converterNumero() {
            ...
            if (numero >= 1 || numero <= 100) {
                document.getElementById("resultado").textContent = numerosPorExtenso[numero - 1];
            } else {
                document.getElementById("resultado").textContent = "Número fora do intervalo suportado.";
            }
        }
